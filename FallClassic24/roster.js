...
//     const url = 'https://script.google.com/macros/s/AKfycbxkYMmIYwgUGnEP4Bp2dkSzwry4HpmuOvSv1eJIstwmtqT1cRh6rGsNH_hKVgvI6DX3/exec'; // Replace with your Web App URL
//     const response = await fetch(url);
//     const data = await response.json();

//     const dataTable = document.getElementById('roster-table').getElementsByTagName('tbody')[0];
//     dataTable.innerHTML = '';
...
const ssid = "192n9oY-QDZGaOXeG8UIOI8rrvQQfnzS5p2nBRnC7RK8";
